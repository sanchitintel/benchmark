...
class Model(TorchVisionModel):
    ...
    def __init__(self, device=None, jit=False, fuser="", dtype="fp32", train_bs=4, eval_bs=4, extra_args=[]):
        super().__init__(model_name="vgg16", device=device, jit=jit, fuser=fuser, dtype=dtype,
