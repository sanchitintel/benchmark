...
class Model(TorchVisionModel):
    ...
    def __init__(self, device=None, jit=False, fuser="", dtype="fp32", train_bs=16, eval_bs=16, extra_args=[]):
        super().__init__(model_name="squeezenet1_1", device=device, jit=jit, fuser=fuser, dtype=dtype,
