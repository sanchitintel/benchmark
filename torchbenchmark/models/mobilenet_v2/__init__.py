...
class Model(TorchVisionModel):
    ...
    def __init__(self, device=None, jit=False, fuser="", train_bs=96, eval_bs=96, dynamic_bs=0, extra_args=[]):
        super().__init__(model_name="mobilenet_v2", device=device, jit=jit, fuser=fuser,
