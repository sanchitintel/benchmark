...
class Model(TorchVisionModel):
    ...
    def __init__(self, device=None, jit=False, fuser="", train_bs=32, eval_bs=32, extra_args=[]):
        super().__init__(model_name="mobilenet_v3_large", device=device, jit=jit, fuser=fuser,
